...
// Output
	...
	//if (fabs (balance) > 1.0 )
		//printf ("WaterBalance %f = plus %f - minus %f\n",balance, (precip + irrUptakeRiver + irrUptakeExcess), (etp + runoff + grdWaterChg + snowPackChg + soilMoistChg + smallResStorageChg));
		//printf ("TIEM %i WaterBalance! %f precip %f irrUptakeRiver %f irrUptakeExcess %f etp %f runoff %f Demand %f\n", itemID ,balance,precip,	irrUptakeExcess,irrUptakeExcess,etp,runoff,		irrGrossDemand);
